  ...
  <div class="no-padding no-margins" style="background: white;width: 100%;height: 1200px">
    ...
    <div class="home-center" style="height: 480px;top: 66px;">
      ...
      <div class="register-input-div">
        ...
        <ul class="dropdown-menu attopic" style="width: 39%;top: 187px;left: 15%">
      ...
      <div class="register-input-div" style="width: 100%">
        ...
        <ul v-show="province_items.length>0"  class="dropdown-menu attopic" style="width: 18%;top: 386px;left: 15%">
        ...
        <ul v-show="city_items.length>0" class="attopic dropdown-menu" style="width: 17%;top: 386px;left: 37%">
    ...
    <div class="home-center" style="height: 520px;background: white;top: 541px;">
      ...
      <div class="register-input-div" style="margin-top: 26px;width: 100%">
        ...
        <label style="width: 14%;text-align: right">微&nbsp;&nbsp;信:</label><input style="width: 30%" class="register-input" placeholder="微信账号" v-model="wechatAccount" name="wechatAccount">
      </div>
      <div class="register-input-div" style="margin-top: 26px;width: 100%">
        <label style="width: 14%"><div class="red-star">*</div>手  机  号:</label><input @focus="getFocus(contactPhone)" @blur="loseFocus(contactPhone)" style="width: 40%" class="register-input" placeholder="请填写手机号码" type="tel" maxlength="11" v-model="contactPhone" name="contactPhone">
      ...
      <div style="margin-left: 35%;margin-top: 106px">
        ...
        <router-link target="_blank"   :to="{ path: 'ljhy_service'}" append >
    ...
    <div style="width:100%;height:200px;" class="register-bottom-div">
        <div class="contact-bg">
          <div style="width:805px;height:120px;margin:0 auto;">
      ...
      submitClick: function () {
       ...
       if (this.agree_clickCheck){
          if (this.hospitalName && this.hospitalType && this.legalName && this.legalCard
            && this.address && this.contactName && this.contactPhone && this.validCode && $("#picFile").val()){
              if (this.contactPhone.length == 11){
