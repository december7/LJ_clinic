      ...
      <div class="col-sm-12">
        ...
        <div class="col-sm-4" style="float: right; margin-right: 10px;">
          <div class="search_background">
            <input v-model="waitParams.userName" @keyup.enter="chargeOrderWait" type="text" placeholder="请输入需要搜索的姓名" class="serach_box">
            <span style="color: lightgray; margin-left: 33px">|</span>
            <button @click="chargeOrderWait" style="border: none; background-color: white"><img src="../../../../static/img/set_manage_img/search.png"></button>
          </div>
        </div>
      </div>
            ...
            <div class="ibox patient_item">
              ...
              <div class="ibox-content patient_ibox-content">
                ...
                <div class="patient_msg_list">
                  ...
                  <div class="m-t-sm">
                    <a href="#/doctor_charge/doctor_charge_confirm" @click="chargeConfirmClick(data_item)"><button class="charge_btn">收费 : ￥{{data_item.waitPay}}元</button></a>
                  </div>
                </div>
