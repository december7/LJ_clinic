          ...
          <div class="col-md-12 no-padding">
            <table class="table no-margins text-center white-bg">
              ...
              <tr class="gradeC"   v-for="(chinese_prescription_item, index) in auditContent" >
                ...
                <td :class="chinese_prescription_item.focus && currentFocusIndex == 7 ? 'focus_border' : 'l_border' " class="   text-center"><input @focus="getFocus(chinese_prescription_item, 7)" @blur="loseFocus(chinese_prescription_item)" class="form-control white-bg no-padding text-center no-borders" type="text" style="height: auto;width: 100%;"v-model="chinese_prescription_item.lowestProcurementPrice"> </td>
...
<script>
  ...
  export default {
    ...
    computed : {
      ...
      no(){
        return this.$store.getters.getCompileSuppliersNo;
      }
    ...
    methods: {
      ...
      returnPage: function () {
        ...
        this.$router.replace('/medicine/warehouse');
      },
