  ...
  <div class="row screen_container">
        <div class="col-sm-12">
          ...
          <div v-show="selectedIndex == 3">
            <div class="form-group white-bg screen_right_container" id="data_1">
              <div class="pull-left input-group date">
                <div class="pull-left"><input readonly type="text" placeholder="起始日期" id="startDate"></div>
              ...
              <div class="pull-left input-group date">
                <div class="pull-left"><input id="endDate" readonly type="text" placeholder='截止日期'></div>
